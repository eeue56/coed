...
Parser is based on Tegan, Derw and Mojie's parsers.
...
- Postfix call/member/index/update forms are limited to name lookups on the left side (for example: `fn()`, `obj.key`, `obj["key"]`, `arr[0]`, `name++`)
