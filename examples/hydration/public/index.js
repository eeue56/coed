(() => {
  ...
  var require_basics = __commonJS({
    "../../../../../node_modules/@eeue56/ts-core/build/main/lib/basics.js"(exports) {
      "use strict";
  ...
  var require_debug = __commonJS({
    "../../../../../node_modules/@eeue56/ts-core/build/main/lib/debug.js"(exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
      exports.log = void 0;
  ...
  var require_tuple = __commonJS({
    "../../../../../node_modules/@eeue56/ts-core/build/main/lib/tuple.js"(exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
  ...
  var require_main = __commonJS({
    "../../../../../node_modules/@eeue56/ts-core/build/main/index.js"(exports) {
      "use strict";
      var __createBinding = exports && exports.__createBinding || (Object.create ? function(o, m, k, k2) {
        if (k2 === void 0)
          k2 = k;
    ...
    "../../build/coed.js"(exports) {
        ...
        attributes.forEach((attribute2) => {
          switch (attribute2.kind) {
            case "string":
              ...
              knownStringAttributes[attribute2.key].push(attribute2);
              break;
            case "style":
      ...
      function render(node2, depth = 0) {
        ...
        switch (node2.kind) {
          ...
          case "void":
          case "regular":
            const attributes = (node2.attributes.length > 0 ? " " : "") + node2.attributes.map(renderAttribute).join(" ");
            switch (node2.kind) {
              case "void":
                return whitespace + `<${node2.tag}${attributes}>`;
              case "regular": {
...
${whitespace}</${node2.tag}>`;
                ...
                return whitespace + `<${node2.tag}${attributes}></${node2.tag}>`;
              }
            }
        }
      }
        ...
        switch (node2.kind) {
          ...
          case "regular":
            ...
            switch (node2.kind) {
              ...
              case "regular": {
                if (node2.children.length > 0) {
                  return `<${node2.tag}${attributes}>${node2.children.map((child) => flatRender(child)).join("")}</${node2.tag}>`;
                }
      ...
      function hydrate2(program3, root) {
        ...
        const node2 = program3.program.view(program3.program.initialModel);
      ...
      function triggerEvent(eventName, payload, node2) {
        switch (node2.kind) {
          ...
          case "void":
          case "regular":
            const events = node2.events.filter((event) => event.name === eventName);
            if (events.length > 0) {
        ...
        switch (tree.kind) {
          ...
          case "void":
            return voidNode(tree.tag, tree.events.map((event) => {
              return on2(event.name, (data2) => tagger(event.tagger(data2)));
            }), tree.attributes);
          case "regular":
      ...
      function setAttributeOnElement(element, attribute2) {
        switch (attribute2.kind) {
          case "string":
          case "number":
            const hasSameAttributeAlready = element.getAttribute(attribute2.key) === attribute2.value;
        ...
        switch (nextTree.kind) {
          ...
          case "regular": {
            if (previousTree.kind === nextTree.kind) {
              previousTree.attributes.filter((attribute2) => {
                for (const nextAttribute of nextTree.attributes) {
                  let seen = false;
                  if (attribute2.kind === nextAttribute.kind) {
                    switch (nextAttribute.kind) {
                      case "number":
                      case "string": {
                        seen = nextAttribute.key === attribute2.key;
                        break;
                      }
                      case "style":
                        seen = true;
                ...
                switch (attribute2.kind) {
                  case "number":
                    elements.removeAttribute(attribute2.key);
                  case "string":
                    elements.removeAttribute(attribute2.key);
                  case "style":
            ...
            if (currentTree.tag !== nextTree.tag || currentTreeId !== nextTreeId) {
              ...
              for (var i2 = 0; i2 < nextTree.children.length; i2++) {
                ...
                switch (node2.nodeType) {
                  ...
                  case Node.TEXT_NODE:
                    const text3 = node2;
                    patch(listener, currentChild, nextChild, text3);
                    break;
                }
              }
              for (var i2 = htmlElements.childNodes.length - 1; i2 > nextTree.children.length - 1; i2--) {
                const node2 = htmlElements.childNodes[i2];
          ...
          if (currentTree === null) {
            ...
            if (program3.root !== "hydration") {
              while (program3.root.firstChild) {
                program3.root.removeChild(program3.root.firstChild);
              }
  ...
  function update(msg, model, send) {
    switch (msg.kind) {
      ...
      case "GotError":
        return Failure();
      case "Fetch": {
        fetch("https://elm-lang.org/assets/public-opinion.txt").then((data) => {
  ...
  function viewState(model) {
    switch (model.kind) {
      ...
      case "Success":
        return (0, import_coed.pre)([], [], [(0, import_coed.text)(model.text)]);
    }
  }
  function view(model) {
    return coed.div([], [], [
      coed.button([coed.on("click", () => Fetch())], [], [(0, import_coed.text)("Fetch text")]),
      viewState(model)
    ]);
  }
