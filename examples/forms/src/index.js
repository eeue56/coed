...
function SetPasswordAgain(passwordAgain) {
    return {
...
function viewInput(type_, placeholder, value, onInput) {
    return coed.input([coed.onInput(onInput)], [
...
function view(model) {
    return coed.div([], [], [
        ...
        viewInput("password", "Re-enter password", model.passwordAgain, SetPasswordAgain),
